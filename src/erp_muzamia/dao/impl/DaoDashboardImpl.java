...
import erp_muzamia.dao.DaoDashboard;
...
public class DaoDashboardImpl implements DaoDashboard {
    ...
    public List<Object[]> listarDashboardSv() {
        ...
        sql.append("SELECT ")
                ...
                .append("ORDER BY dope_cantidad DESC ")
                .append("LIMIT 10;");
    ...
    public List<Object[]> listarDashboardMt(String ini, String fin) {
        ...
        sql.append("SELECT ")
                ...
                .append("serv_id,")
                .append("serv_nombre,")
                .append("IFNULL(SUM(dope_cantidad),0) AS dope_cantidad,")
                .append("IFNULL(SUM(dope_total),0) AS dope_total,")
                .append("oper_fecha ")
                .append("FROM DASHBOARD_SV2 ")
                .append("WHERE oper_fecha BETWEEN ")
                .append("'" + ini + "' and '" + fin + "' ")
                .append("GROUP BY serv_id ")
                .append("ORDER BY dope_total DESC ")
                .append("LIMIT 10;");
    ...
    public List<Object[]> listarDashboard(List<Integer> ids) {
        ...
        sql.append("SELECT ")
                ...
                .append("LEFT JOIN DASHBOARD_OP d ")
                .append("ON c.caja_id = d.caja_id ")
                .append("WHERE d.caja_id in (" + strIds.substring(0, strIds.length() - 1) + ");");
