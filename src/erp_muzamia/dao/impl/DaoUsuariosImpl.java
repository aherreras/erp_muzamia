...
public class DaoUsuariosImpl implements DaoUsuarios {
    ...
    public List<Usuarios> listarUsuarios() {
        ...
        sql.append("SELECT ")
                ...
                .append("user_rol ")
                .append("FROM USUARIOS ")
                .append("WHERE user_rol = 'ESTILISTA' ")
        ...
        try ( Connection cn = db.getConnection();  PreparedStatement ps = cn.prepareStatement(sql.toString())) {
            ...
            try ( ResultSet rs = ps.executeQuery()) {
                while (rs.next()) {
                    ...
                    usuarios.setUser_fecha_nacimiento(rs.getString(5));
                    usuarios.setUser_dni(rs.getInt(6));
                    usuarios.setUser_estado(rs.getBoolean(7));
                    usuarios.setUser_fecha_ingreso(rs.getString(8));
                    usuarios.setUser_fecha_salida(rs.getString(9));
                    usuarios.setUser_rol(rs.getString(10));
                    list.add(usuarios);
                }
            }
