 ...
 * @author User
 */
public class ClienteUI_OLD extends javax.swing.JFrame {

    /**
     * Creates new form ClienteUI
     */
    public ClienteUI_OLD() {
        initComponents();
        listarColumnasTabla();
        listarClientes();
        inicializarDatos();
    ...
    public void listarColumnasTabla() {
        ...
        jtClientes.getColumnModel().getColumn(4).setMaxWidth(150);
        jtClientes.getColumnModel().getColumn(4).setMinWidth(150);
        jtClientes.getTableHeader().getColumnModel().getColumn(4).setMaxWidth(150);
        jtClientes.getTableHeader().getColumnModel().getColumn(4).setMinWidth(150);

        jtClientes.getColumnModel().getColumn(5).setMaxWidth(60);
        jtClientes.getColumnModel().getColumn(5).setMinWidth(60);
        jtClientes.getTableHeader().getColumnModel().getColumn(5).setMaxWidth(60);
        jtClientes.getTableHeader().getColumnModel().getColumn(5).setMinWidth(60);
    }
    ...
    public void listarClientes() {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            row[4] = list.get(i).getClie_timestamp();
...
// Botones laterales
    ...
    private void initComponents() {
        ...
        jtClientes.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nombres", "Apellidos", "DNI", "F. Ult. Mod.", "Estado"
            }
        ) {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Acción"));
        ...
        jbNuevo.setBackground(new java.awt.Color(51, 51, 255));
        ...
        jbEliminar.setBackground(new java.awt.Color(255, 153, 0));
        ...
        jbModificar.setBackground(new java.awt.Color(255, 204, 204));
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jtfBuscar, javax.swing.GroupLayout.PREFERRED_SIZE, 348, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ClienteUI_OLD.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ClienteUI_OLD().setVisible(true);
            }
        });
    }
